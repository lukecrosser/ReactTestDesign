...
root.render(
  ...
  <React.StrictMode>
      ...
      <div className="mx-auto w-fit flex-col lg:flex justify-between items-center -mt-20">
          <Chat />
          <h1 className="mb-5 w-6/12 text-black text-5xl font-bold ">Say goodbye to Web Design!<p className="text-sm mt-5 text-black font-light py-6">If you sign with us you'll never have to deal
      ...
      <div className="mx-auto w-fit flex justify-between items-center mt-20">
          <div className="hero-content flex-col lg:flex-row-reverse inset-x-0 top-0">
              ...
              <div>
                  <h1 className="text-5xl font-bold ">Say Hello to Luo Design!</h1>
